...
4. Quản lý Đánh giá sản phẩm (Duyệt, Trả lời, Xóa). (Quản lý đấy nhé, phải đọc kĩ code BE xem chính xác các chức năng CURD nếu có xử lý như nào, có thể yêu cầu BE update như nào cũng được miễn sao đúng chuẩn, đọc kĩ code BE nhé, không chỉ đọc docs api)
