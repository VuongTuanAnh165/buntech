...
import {
  ArrowRight, Sparkles, Truck, ShieldCheck, Clock, Star,
  Package, Quote, ChevronRight, Leaf, Award, Store, Heart,
  ShoppingBag, Search,
        ...
        <div class="max-w-2xl">
          ...
          <div class="flex flex-col sm:flex-row gap-3 animate-fade-in-up" style="animation-delay: 200ms">
            ...
            <NuxtLink to="/products" class="block">
              <AppButton variant="outline" size="lg" class="w-full sm:w-auto !bg-white/10 !border-white/30 !text-white hover:!bg-white/20">
                Xem sản phẩm
              </AppButton>
            </NuxtLink>
          </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
        ...
        >
          ...
          <p class="text-xs text-slate-400 dark:text-zinc-500 mt-1">{{ mockProducts.filter((p: any) => p.category_id === cat.id).length }} sản phẩm</p>
        </NuxtLink>
      </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div v-if="loading" class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div v-for="i in 8" :key="i" class="card p-4">
          <AppSkeleton height="h-48" class="mb-4" />
      ...
      <div class="sm:hidden mt-6">
        <NuxtLink to="/products">
          <AppButton variant="outline" block>Xem tất cả sản phẩm</AppButton>
        </NuxtLink>
      </div>
    </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="flex items-center gap-3">
            <AppAvatar :name="testimonial.name" size="sm" />
            <div>
