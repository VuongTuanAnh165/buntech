...
const option = computed(() => {
  const base = {
    tooltip: {
      ...
      extraCssText:
        'border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); padding: 10px 14px;'
    }
  }
  if (props.type === 'pie') {
    return {
      ...
      series: [
        {
          ...
          itemStyle: {
            borderRadius: 8,
            borderColor: isDark.value ? '#27272a' : '#fff',
            borderWidth: 2
          },
          label: { show: false },
          emphasis: {
  ...
  if (props.type === 'bar') {
    return {
      ...
      xAxis: {
        ...
        axisTick: { show: false },
        axisLabel: {
          color: isDark.value ? '#a1a1aa' : '#9ca3af',
          fontSize: 11,
          fontWeight: 500,
          interval: 0,
    ...
    series: [
      {
        ...
        lineStyle: {
          color: '#ed7628',
          width: 3,
          shadowColor: 'rgba(237,118,40,0.3)',
          shadowBlur: 10,
          shadowOffsetY: 4
        },
        itemStyle: {
